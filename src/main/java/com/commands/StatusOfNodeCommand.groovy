...
def class StatusOfNodeCommand extends Base implements Command {
    ...
    def execute() {
        ...
        doesCarrierExist(carrierName) ? chosenHub(carrierName)
    ...
    def chosenHub(String carrierName) {
        ...
        doesHubExist(carrierName, hubName) ? searchHubAvailability(carrierName, hubName)
                : notExists(hubName)
    }
    ...
    def searchNode(String carrierName, String hubName) {
        ...
        doesNodeExist(carrierName, hubName, nodeName) ? nodeAvailabilty(carrierName, hubName, nodeName)
                : notExists(hubName)
    }
